...
from mg_scheduling.initialize import initialize_megatron
from mg_scheduling.initialize import write_args_to_tensorboard
from mg_scheduling.initialize import set_jit_fusion_options

from megatron.training.optimizer_param_scheduler import OptimizerParamScheduler
from megatron.legacy.data.data_samplers import build_pretraining_data_loader
from megatron.core.transformer.moe.moe_utils import track_moe_metrics
# from megatron.core.pipeline_parallel import get_forward_backward_func
from mg_scheduling.schedules import get_forward_backward_func
...
def pretrain(train_valid_test_dataset_provider,
    ...
    model, optimizer, opt_param_scheduler = None
...
def train_step(args):
    ...
    # record_name = str(args.simu_rank) + ":init:optimizer_zero:" + str(args.simu_micro_batch_ids["optimizer_zero"])
    # args.simu_stage_operations_trace.append(record_name)
    # Forward pass.
    forward_backward_func = get_forward_backward_func(args.pipeline_model_parallel_size)
    ...
    record_name = str(args.simu_rank) + ":finalize:optimizer_step:" + str(args.simu_micro_batch_ids["optimizer_step"])
    args.simu_stage_operations_trace.append(record_name)
    ...
    if mpu.is_pipeline_last_stage(ignore_virtual=True):
        ...
        args.simu_micro_batch_ids["average_mbsloss"] += 1
        record_name = str(args.simu_rank) + ":finalize:average_mbsloss:" + str(args.simu_micro_batch_ids["average_mbsloss"])
        args.simu_stage_operations_trace.append(record_name)
        # loss_reduced = {}
