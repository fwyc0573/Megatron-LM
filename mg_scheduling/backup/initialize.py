...
import mg_scheduling.parallel_state as mpu
# from megatron.training.arguments import parse_args, validate_args
from mg_scheduling.arguments import parse_args, validate_args
...
def _initialize_distributed():
    ...
    if device_count > 0:
        if mpu.model_parallel_is_initialized():
            ...
            # TODO:这里初始化好像可略过(查看后续mpu是否被使用)
            rank_genarator = mpu.initialize_model_parallel(
