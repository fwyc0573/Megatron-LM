...
def parse_arguments():
    ...
    precision_group.add_argument("--fp16", action='store_true', help="Enable fp16 precision (for pipeline_dtype)")
    precision_group.add_argument("--bf16", action='store_true', help="Enable bf16 precision (for pipeline_dtype)")
    parser.add_argument(
        "--output-dir",
        default=None,
        help="Explicit scheduling-plan output directory. Uses deterministic stage filenames when set.",
    )
