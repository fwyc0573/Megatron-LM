class MPUInfo:
    def __init__(self, dp_size, tp_size, pp_size, dp_groups, pp_groups, tp_groups, mp_groups, ep_groups=None, pep_groups=None, exp_groups=None, cp_groups=None, cp_size=1, exp_size=1, dp_modulo_exp_groups=None, tp_exp_groups=None, tp_dp_groups=None):
        ...
        self.ep_size = len(ep_groups[0]) if ep_groups and len(ep_groups) > 0 else 0
        self.pep_size = len(pep_groups[0]) if pep_groups and len(pep_groups) > 0 else 0
...
class ParallelGroupManager:
    ...
    def _initialize_groups(self):
        ...
        from src.core.static_graphs.sim_parallel_state import sim_initialize_model_parallel
