...
if __name__ == "__main__":
    ...
    # framwork='megatron-lm'
    # mg_trace_filepath = r'megatron_operation_log/h800_64gpus_8pp_4tp_13b/global_ranks_profile' #r'H:\HUBOther\ML_Sys_Merak\TorchGraph\megatron_operation_log\256_4pp_8tp_8dp_70BLLAMA\global_ranks_profile'
    # stages_scheduling_filepath = r"megatron_operation_log/h800_64gpus_8pp_4tp_13b/schedule"
    # torchgraph_filepath = r"megatron_operation_log/h800_64gpus_8pp_4tp_13b/database_profile"
    # curr_world_size = 64
    # curr_pp_size = 8
    # curr_tp_size = 4
    ...
    """   64 gpu sim time"""
    # framwork='megatron-lm'
    # mg_trace_filepath = None # r'H:\HUBOther\ML_Sys_Merak\TorchGraph\megatron_operation_log\tmp_test_for_sim_time\global_ranks_profile' #r'H:\HUBOther\ML_Sys_Merak\TorchGraph\megatron_operation_log\256_4pp_8tp_8dp_70BLLAMA\global_ranks_profile'
    # stages_scheduling_filepath = r"./megatron_operation_log/sim_time_test_64/schedule"
    # torchgraph_filepath = r"./megatron_operation_log/sim_time_test_64/database_profile"
    # curr_world_size = 64
    # curr_pp_size = 4
    # curr_tp_size = 8
    ...
    # framwork='megatron-lm'
    # mg_trace_filepath = None # r'H:\HUBOther\ML_Sys_Merak\TorchGraph\megatron_operation_log\tmp_test_for_sim_time\global_ranks_profile' #r'H:\HUBOther\ML_Sys_Merak\TorchGraph\megatron_operation_log\256_4pp_8tp_8dp_70BLLAMA\global_ranks_profile'
    # stages_scheduling_filepath = r"H:\HUBOther\ML_Sys_Merak\TorchGraph\megatron_operation_log\sim_time_test_256\schedule"
    # torchgraph_filepath = r"H:\HUBOther\ML_Sys_Merak\TorchGraph\megatron_operation_log\sim_time_test_256\database_profile"
    # curr_world_size = 256
    # curr_pp_size = 8
    # curr_tp_size = 8
    ...
    # framwork='megatron-lm'
    # mg_trace_filepath = None # r'H:\HUBOther\ML_Sys_Merak\TorchGraph\megatron_operation_log\tmp_test_for_sim_time\global_ranks_profile' #r'H:\HUBOther\ML_Sys_Merak\TorchGraph\megatron_operation_log\256_4pp_8tp_8dp_70BLLAMA\global_ranks_profile'
    # stages_scheduling_filepath = r"H:\HUBOther\ML_Sys_Merak\TorchGraph\megatron_operation_log\sim_time_test_1024\schedule"
    # torchgraph_filepath = r"H:\HUBOther\ML_Sys_Merak\TorchGraph\megatron_operation_log\sim_time_test_1024\database_profile"
    # curr_world_size = 1024
    # curr_pp_size = 4
    # curr_tp_size = 8
    ...
    # framwork='megatron-lm'
    # mg_trace_filepath = None # r'H:\HUBOther\ML_Sys_Merak\TorchGraph\megatron_operation_log\tmp_test_for_sim_time\global_ranks_profile' #r'H:\HUBOther\ML_Sys_Merak\TorchGraph\megatron_operation_log\256_4pp_8tp_8dp_70BLLAMA\global_ranks_profile'
    # stages_scheduling_filepath = r"megatron_operation_log/sim_time_test_4096/schedule"
    # torchgraph_filepath = r"megatron_operation_log/sim_time_test_4096/database_profile"
    # curr_world_size = 4096
    # curr_pp_size = 4
    # curr_tp_size = 8
    ...
    # framwork='megatron-lm'
    # mg_trace_filepath = None # r'H:\HUBOther\ML_Sys_Merak\TorchGraph\megatron_operation_log\tmp_test_for_sim_time\global_ranks_profile' #r'H:\HUBOther\ML_Sys_Merak\TorchGraph\megatron_operation_log\256_4pp_8tp_8dp_70BLLAMA\global_ranks_profile'
    # stages_scheduling_filepath = r"/research/d1/gds/ytyang/yichengfeng/sim_time_test/megatron_operation_log/sim_time_test_8192/schedule"
    # torchgraph_filepath = r"/research/d1/gds/ytyang/yichengfeng/sim_time_test/megatron_operation_log/sim_time_test_8192/database_profile"
    # curr_world_size = 8192
    # curr_pp_size = 4
    # curr_tp_size = 8
    ...
    """  MODELtiny_pp2_tp1_dp2_seq2048_mbs2_gbs4_fp16 """
    # framwork='megatron-lm'
    # mg_trace_filepath = r'megatron_operation_log/moe_tiny_2pp_1tp_2dp/global_ranks_profile' #r'H:\HUBOther\ML_Sys_Merak\TorchGraph\megatron_operation_log\256_4pp_8tp_8dp_70BLLAMA\global_ranks_profile'
    # stages_scheduling_filepath = r"megatron_operation_log/moe_tiny_2pp_1tp_2dp/schedule"
    # torchgraph_filepath = r"megatron_operation_log/moe_tiny_2pp_1tp_2dp/database_profile"
    # curr_world_size = 4
    # curr_pp_size = 2
    # curr_tp_size = 1
    # curr_exp_size = 2

    # """  MODEL6.7b_pp2_tp1_dp2_seq2048_mbs2_gbs4_fp16 """
    # framwork='megatron-lm'
    # mg_trace_filepath = r'megatron_operation_log/moe_6.7b_2pp_1tp_2dp/global_ranks_profile' #r'H:\HUBOther\ML_Sys_Merak\TorchGraph\megatron_operation_log\256_4pp_8tp_8dp_70BLLAMA\global_ranks_profile'
    # stages_scheduling_filepath = r"megatron_operation_log/moe_6.7b_2pp_1tp_2dp/schedule"
    # torchgraph_filepath = r"megatron_operation_log/moe_6.7b_2pp_1tp_2dp/database_profile"
    # curr_world_size = 4
    # curr_pp_size = 2
    # curr_tp_size = 1
    # curr_exp_size = 2

    """  moe_mixtral8_1.75b_2pp_1tp_4dp_2ep_fp16 4096"""
    # framwork='megatron-lm'
    # mg_trace_filepath = r'megatron_operation_log/moe_mixtral8_1.75b_2pp_1tp_4dp_2ep_4096seq/global_ranks_profile' #r'H:\HUBOther\ML_Sys_Merak\TorchGraph\megatron_operation_log\256_4pp_8tp_8dp_70BLLAMA\global_ranks_profile'
    # stages_scheduling_filepath = r"megatron_operation_log/moe_mixtral8_1.75b_2pp_1tp_4dp_2ep_4096seq/schedule"
    # torchgraph_filepath = r"megatron_operation_log/moe_mixtral8_1.75b_2pp_1tp_4dp_2ep_4096seq/database_profile"
    # curr_world_size = 8
    # curr_pp_size = 2
    # curr_tp_size = 1
    # curr_exp_size = 2

    """  moe_mixtral8_1.75b_2pp_1tp_4dp_4ep_fp16 4096"""
    # framwork='megatron-lm'
    # mg_trace_filepath = r'megatron_operation_log/moe_mixtral8_1.75b_2pp_1tp_4dp_4ep_4096seq/global_ranks_profile' #r'H:\HUBOther\ML_Sys_Merak\TorchGraph\megatron_operation_log\256_4pp_8tp_8dp_70BLLAMA\global_ranks_profile'
    # stages_scheduling_filepath = r"megatron_operation_log/moe_mixtral8_1.75b_2pp_1tp_4dp_4ep_4096seq/schedule"
    # torchgraph_filepath = r"megatron_operation_log/moe_mixtral8_1.75b_2pp_1tp_4dp_4ep_4096seq/database_profile"
    # curr_world_size = 8
    # curr_pp_size = 2
    # curr_tp_size = 1
    # curr_exp_size = 4
    ...
    # """  h800 moe_mixtral8_1.75b_2pp_1tp_4dp_2ep_fp16 4096"""
    # framwork='megatron-lm'
    # mg_trace_filepath = r'megatron_operation_log/h800_moe_mixtral8_1.75b_2pp_1tp_4dp_2ep_4096seq/global_ranks_profile' #r'H:\HUBOther\ML_Sys_Merak\TorchGraph\megatron_operation_log\256_4pp_8tp_8dp_70BLLAMA\global_ranks_profile'
    # stages_scheduling_filepath = r"megatron_operation_log/h800_moe_mixtral8_1.75b_2pp_1tp_4dp_2ep_4096seq/schedule"
    # torchgraph_filepath = r"megatron_operation_log/h800_moe_mixtral8_1.75b_2pp_1tp_4dp_2ep_4096seq/database_profile"
    # curr_world_size = 16
    # curr_pp_size = 2
    # curr_tp_size = 1
    # curr_exp_size = 8

    """  h800 moe_mixtral8_1.75b_2pp_1tp_4dp_4ep_fp16 4096"""
    # framwork='megatron-lm'
    # mg_trace_filepath = r'megatron_operation_log/h800_moe_mixtral8_1.75b_2pp_1tp_4dp_4ep_4096seq/global_ranks_profile' #r'H:\HUBOther\ML_Sys_Merak\TorchGraph\megatron_operation_log\256_4pp_8tp_8dp_70BLLAMA\global_ranks_profile'
    # stages_scheduling_filepath = r"megatron_operation_log/h800_moe_mixtral8_1.75b_2pp_1tp_4dp_4ep_4096seq/schedule"
    # torchgraph_filepath = r"megatron_operation_log/h800_moe_mixtral8_1.75b_2pp_1tp_4dp_4ep_4096seq/database_profile"
    # curr_world_size = 8192
    # curr_pp_size = 32
    # curr_tp_size = 4
    # curr_exp_size = 1
    ...
    # framwork = 'megatron-lm'
    # mg_trace_filepath = None # 'megatron_operation_log/4pp_2dp_7llama/global_ranks_profile'
    # stages_scheduling_filepath = "megatron_operation_log/2pp_2_2_tiny_llama/schedule"
    # torchgraph_filepath = "megatron_operation_log/2pp_2_2_tiny_llama/database_profile"
    # curr_world_size = 8
    # curr_pp_size = 2
    # curr_tp_size = 2
    # curr_exp_size = 1
    ...
    """  16GPUs-h800: pp2_tp1_exp2_expn8_dp8_nl8_hs4096_sl1024"""
    # framwork='megatron-lm'
    # mg_trace_filepath = r'megatron_operation_log/new_moe/pp2_tp1_exp2_expn8_dp8_nl8_hs4096_sl1024/global_ranks_profile' #r'H:\HUBOther\ML_Sys_Merak\TorchGraph\megatron_operation_log\256_4pp_8tp_8dp_70BLLAMA\global_ranks_profile'
    # stages_scheduling_filepath = r"megatron_operation_log/new_moe/pp2_tp1_exp2_expn8_dp8_nl8_hs4096_sl1024/schedule"
    # torchgraph_filepath = r"megatron_operation_log/new_moe/pp2_tp1_exp2_expn8_dp8_nl8_hs4096_sl1024/database_profile"
    # curr_world_size = 16
    # curr_pp_size = 2
    # curr_tp_size = 1
    # curr_exp_size = 2
    ...
    """  16GPUs-h800: pp4_tp1_exp2_expn8_dp4_nl8_hs4096_sl1024"""
    # framwork='megatron-lm'
    # mg_trace_filepath = r'megatron_operation_log/h800_16gpus_moe/pp4_tp1_exp2_expn8_dp4_nl8_hs4096_sl1024/global_ranks_profile' #r'H:\HUBOther\ML_Sys_Merak\TorchGraph\megatron_operation_log\256_4pp_8tp_8dp_70BLLAMA\global_ranks_profile'
    # stages_scheduling_filepath = r"megatron_operation_log/h800_16gpus_moe/pp4_tp1_exp2_expn8_dp4_nl8_hs4096_sl1024/schedule"
    # torchgraph_filepath = r"megatron_operation_log/h800_16gpus_moe/pp4_tp1_exp2_expn8_dp4_nl8_hs4096_sl1024/database_profile"
    # curr_world_size = 16
    # curr_pp_size = 4
    # curr_tp_size = 1
    # curr_exp_size = 2
    ...
    """  16GPUs-h800: pp2_tp1_exp2_expn8_dp8_nl8_hs4096_sl1024"""
    # framwork='megatron-lm'
    # mg_trace_filepath = r'megatron_operation_log/h800_16gpus_moe/pp2_tp1_exp2_expn8_dp8_nl8_hs4096_sl1024/global_ranks_profile' #r'H:\HUBOther\ML_Sys_Merak\TorchGraph\megatron_operation_log\256_4pp_8tp_8dp_70BLLAMA\global_ranks_profile'
    # stages_scheduling_filepath = r"megatron_operation_log/h800_16gpus_moe/pp2_tp1_exp2_expn8_dp8_nl8_hs4096_sl1024/schedule"
    # torchgraph_filepath = r"megatron_operation_log/h800_16gpus_moe/pp2_tp1_exp2_expn8_dp8_nl8_hs4096_sl1024/database_profile"
    # curr_world_size = 16
    # curr_pp_size = 2
    # curr_tp_size = 1
    # curr_exp_size = 2

    """  16GPUs-h800: pp2_tp1_exp4_expn8_dp8_nl8_hs4096_sl1024"""
    # framwork='megatron-lm'
    # mg_trace_filepath = r'megatron_operation_log/h800_16gpus_moe/pp2_tp1_exp4_expn8_dp8_nl8_hs4096_sl1024/global_ranks_profile' #r'H:\HUBOther\ML_Sys_Merak\TorchGraph\megatron_operation_log\256_4pp_8tp_8dp_70BLLAMA\global_ranks_profile'
    # stages_scheduling_filepath = r"megatron_operation_log/h800_16gpus_moe/pp2_tp1_exp4_expn8_dp8_nl8_hs4096_sl1024/schedule"
    # torchgraph_filepath = r"megatron_operation_log/h800_16gpus_moe/pp2_tp1_exp4_expn8_dp8_nl8_hs4096_sl1024/database_profile"
    # curr_world_size = 16
    # curr_pp_size = 2
    # curr_tp_size = 1
    # curr_exp_size = 4
    ...
    """  16GPUs-h800: pp2_tp1_exp4_expn16_dp8_nl8_hs4096_sl1024"""
    # framwork='megatron-lm'
    # mg_trace_filepath = r'megatron_operation_log/h800_16gpus_moe/pp2_tp1_exp4_expn16_dp8_nl8_hs4096_sl1024/global_ranks_profile' #r'H:\HUBOther\ML_Sys_Merak\TorchGraph\megatron_operation_log\256_4pp_8tp_8dp_70BLLAMA\global_ranks_profile'
    # stages_scheduling_filepath = r"megatron_operation_log/h800_16gpus_moe/pp2_tp1_exp4_expn16_dp8_nl8_hs4096_sl1024/schedule"
    # torchgraph_filepath = r"megatron_operation_log/h800_16gpus_moe/pp2_tp1_exp4_expn16_dp8_nl8_hs4096_sl1024/database_profile"
    # curr_world_size = 16
    # curr_pp_size = 2
    # curr_tp_size = 1
    # curr_exp_size = 4
    ...
    """  16GPUs-h800: pp4_tp1_exp4_expn16_dp4_nl8_hs4096_sl1024"""
    # framwork='megatron-lm'
    # mg_trace_filepath = r'megatron_operation_log/h800_16gpus_moe/pp4_tp1_exp4_expn16_dp4_nl8_hs4096_sl1024/global_ranks_profile' #r'H:\HUBOther\ML_Sys_Merak\TorchGraph\megatron_operation_log\256_4pp_8tp_8dp_70BLLAMA\global_ranks_profile'
    # stages_scheduling_filepath = r"megatron_operation_log/h800_16gpus_moe/pp4_tp1_exp4_expn16_dp4_nl8_hs4096_sl1024/schedule"
    # torchgraph_filepath = r"megatron_operation_log/h800_16gpus_moe/pp4_tp1_exp4_expn16_dp4_nl8_hs4096_sl1024/database_profile"
    # curr_world_size = 16
    # curr_pp_size = 4
    # curr_tp_size = 1
    # curr_exp_size = 4
    ...
    # """  8GPUs-A800: new_test_3pp_2dp_1tp_gpt6.7"""
    # framwork='megatron-lm'
    # mg_trace_filepath = r'megatron_operation_log/new_test_3pp_2dp_1tp_gpt6.7/global_ranks_profile' #r'H:\HUBOther\ML_Sys_Merak\TorchGraph\megatron_operation_log\256_4pp_8tp_8dp_70BLLAMA\global_ranks_profile'
    # stages_scheduling_filepath = r"megatron_operation_log/new_test_3pp_2dp_1tp_gpt6.7/schedule"
    # torchgraph_filepath = r"megatron_operation_log/new_test_3pp_2dp_1tp_gpt6.7/database_profile"
    # curr_world_size = 6
    # curr_pp_size = 3
    # curr_tp_size = 1
    # curr_exp_size = 1
    ...
    """  SIM 32GPUs: sim_32pugs_4pp_4tp_2dp"""
    framwork='megatron-lm'
    mg_trace_filepath = None # r'megatron_operation_log/h800_16gpus_moe/sim_32pugs_4pp_4tp_2dp/global_ranks_profile' #r'H:\HUBOther\ML_Sys_Merak\TorchGraph\megatron_operation_log\256_4pp_8tp_8dp_70BLLAMA\global_ranks_profile'
    stages_scheduling_filepath = r"megatron_operation_log/sim_32pugs_4pp_4tp_2dp/schedule"
    torchgraph_filepath = r"megatron_operation_log/sim_32pugs_4pp_4tp_2dp/database_profile"
    curr_world_size = 32
    curr_pp_size = 4
    curr_tp_size = 4
    curr_exp_size = 1
    ...
    manager = ParallelGroupManager(local_size=local_size, world_size=world_size, pp_size=curr_pp_size, tp_size=curr_tp_size, exp_size=curr_exp_size)
    ...
    simulator_engine.visualize_timelines(wrank_id_start_end=[0, 24])
    # simulator_engine.visualize_timelines(wrank_id_start_end=[0,5])

    # final_execution_time = time.time() - time_execution_start
    # print(f"final sim execution time:{final_execution_time}")